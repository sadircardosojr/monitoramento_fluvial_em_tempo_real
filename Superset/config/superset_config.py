...
#     "rel": "icon"
# },
FAVICONS = [{"href": "/static/assets/images/fav_icon_sistema_visualizacao.png"}]
...
SUPERSET_WEBSERVER_ADDRESS = "localhost" #"ec2-54-210-194-217.compute-1.amazonaws.com" #
...
# SQLALCHEMY_DATABASE_URI = (f"""sqlite:///{os.path.join(DATA_DIR, "superset.db")}?check_same_thread=false""")

DATABASE_DIALECT = get_env_variable("DATABASE_DIALECT") #"postgresql+psycopg2"
...
APP_NAME = "GD - Visualization"

# Specify the App icon
APP_ICON = "/static/assets/images/logo_sistema_visualizacao.png"
...
DEFAULT_FEATURE_FLAGS: dict[str, bool] = {
    ...
    # Allow for javascript controls componentsENABLE_TEMPLATE_PROCESSING
    ...
    "VERSIONED_EXPORT": False,  # deprecated
